  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
        <h1 data-aos="fade-up">Penru IF</h1>
        <h2 data-aos="fade-up" data-aos-delay="400">Website peminjaman ruangan dan alat praktikum untuk Jurusan
  ...
  <div class="container">
    <div class="row d-flex align-items-center">
      <div class="col-lg-12 text-lg-left text-center">
        <div class="copyright">
          &copy; Copyright <strong>Teknik Informatika</strong>. All Rights Reserved
        </div>
