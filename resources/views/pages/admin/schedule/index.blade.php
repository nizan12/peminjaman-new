                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control default-select" id="course" name="course">
                            ...
                            @foreach ($course as $prodi => $matakuliahByProdi)
                            <optgroup label="{{ $prodi }}">
                                @foreach ($matakuliahByProdi as $matkul)

                                <option value="{{ $matkul->id }}" @if( $searchMatakuliah && old('course', $searchMatakuliah)==$matkul->id ) selected @endif >{{ $matkul->code }} | {{ $matkul->name }}</option>
