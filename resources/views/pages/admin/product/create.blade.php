                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nomor_bmn" value="{{ old('nomor_bmn') }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description" value="{{ old('description') }}"
                                                placeholder="Contoh : Meja Kantor Hitam Pendek, Ukuran 150cm x 80cm"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="location" value="{{ old('location') }}"
                                                placeholder="Contoh : Meja Instruktur"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="condition"
                                                class="form-control default-select @error('condition') is-invalid @enderror">
