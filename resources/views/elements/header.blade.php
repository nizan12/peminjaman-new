      ...
      <div class="collapse navbar-collapse justify-content-between">
        ...
        <ul class="navbar-nav header-right">
          ...
          <li class="nav-item dropdown notification_dropdown">
            <a class="nav-link" aria-label="Notification Dropdown" href="javascript:void(0)" data-toggle="dropdown">
          ...
          <li class="nav-item dropdown header-profile">
            <a class="nav-link" aria-label="Dropdown User Menu"  href="javascript:void(0)" role="button" data-toggle="dropdown">
